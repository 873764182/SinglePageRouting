	...
	*/
	...
	function actionSheet() {
	    ...
	    function _hide(callback) {
	        ...
	        $actionSheet.addClass(options.isAndroid ? 'weui-animate-fade-out' : 'weui-animate-slide-download');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function picker() {
	    ...
	    function _hide(callback) {
	        ...
	        $picker.find('.weui-picker').addClass('weui-animate-slide-download').on('animationend webkitAnimationEnd', function () {
	            $picker.remove();
	            _sington = false;
	            defaults.onClose();
	            callback && callback();
